...
def cluster_news_5():
    ...
    try:
        with driver.session() as session:
            ...
            print("Ejecutando K-Means clustering con 5 clústeres...")
            ...
            print("\n📊 Distribución de noticias por clúster (5 clústeres):")
            ...
            with open('kmeans_model_5.pkl', 'wb') as f:
                pickle.dump(kmeans, f)
            print("Modelo guardado como 'kmeans_model_5.pkl'")
            
            print(f"\n✅ Proceso completado:")
            print(f"   Total de noticias procesadas: {total}")
            print(f"   Número de clústeres: 5")
            print(f"   Modelo guardado: kmeans_model_5.pkl")
            print(f"   Confirmación de actualización en Neo4j: ✅")
